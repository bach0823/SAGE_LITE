"""
Baseline Ladder B1: ConvNeXtV2-ViT Hybrid UNet (Pure Baseline without SAGE)
...
- Serves as the Baseline B1 Model for the Baseline Ladder (B0 -> B1 -> B2 -> B3).
...
class B1ConvNeXtViTUNet(nn.Module):
    """
    Baseline B1 Model: ConvNeXtV2-ViT Hybrid UNet.
    ...
    def get_model_info(self) -> Dict[str, Union[int, str]]:
        ...
        return {
            "model_name": "B1ConvNeXtViTUNet (Baseline Ladder B1)",
...
def create_b1_unet(
    ...
    """
    Factory function for Baseline B1 Model.
    """
...
if __name__ == "__main__":
    print("=" * 65)
    print("=== SK3 Self-Test: End-to-End Baseline B1 Model ===")
    print("=" * 65)
    ...
    # 1. Initialize B1 Model (pretrained=False for offline smoke test)
